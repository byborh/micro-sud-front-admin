      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">
            ...
            <li class="nav-item"><a class="nav-link" href="savoir_faire.html">Savoir-faire</a></li>
            <li class="nav-item"><a class="nav-link" href="block_textuel.html">Block Textuel</a></li> -->
          </ul>
        </div>
      </div>
  </nav>
